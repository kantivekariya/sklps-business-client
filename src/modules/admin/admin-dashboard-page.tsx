...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([pending, approved, jobStats]) => {
        setStats({
          totalBusinesses: approved.length + pending.length,
  ...
  const statCards = [
    ...
    { title: "Total Jobs", value: stats.totalJobs, icon: Briefcase, desc: "All job listings" },
    {
      title: "Active Jobs",
    ...
    { title: "Closed Jobs", value: stats.closedJobs, icon: Briefcase, desc: "No longer active" },
  ];
        ...
        <Card className="lg:col-span-3 shadow-sm">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span>Storage</span>
                <span className="text-green-600 font-medium">S3 Active</span>
              </div>
            </div>
          </CardContent>
        </Card>
