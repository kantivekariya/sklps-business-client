...
export default function AdminLayout() {
  ...
  // Show spinner while initial token verification is in progress
  if (loading) return <PageSpinner />;

  // Redirect handled by effect; show nothing while in-flight
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                <Avatar className="h-9 w-9 border-2 border-neutral-700">
                  <AvatarImage
                    src={`https://ui-avatars.com/api/?name=${encodeURIComponent(admin?.name || "Admin")}&background=171717&color=fff`}
                  />
