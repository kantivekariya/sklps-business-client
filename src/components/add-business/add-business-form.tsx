    ...
    try {
      ...
      Object.keys(data).forEach((key) => {
        if (key === "yearsInBusiness") {
          formData.append(key, String(Number(data[key]))); // Ensure it's a number, then convert to string for FormData
      ...
      await api.post(API_ENDPOINTS.BUSINESS_CREATE, formData, {
        headers: {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input
                      ...
                      type="email"
                      {...register("email", {
                        required: "Email is required (you will receive login credentials here after approval)",
                        pattern: {
                          value: /^\S+@\S+$/i,
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="nativePlace" {...register("nativePlace")} placeholder="Native village/town" />
                  </div>
                  <div className="space-y-2">
